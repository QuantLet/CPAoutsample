...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **CPAoutsample** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
PAM.pred = function(X, Y, n.years){
  ...
  for (i2 in 1:(end.datepred - end.date + 1)){
    ...
    while (m < M && b.pts == 0){
      ...
      q99           = quantile(MB.ratios.max, probs = 1-(0.01*k/M))
